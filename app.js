...
const speciesExtraInfo = {
    ...
    "Colarraqueta de botas blancas - hembra": {
    ...
    "Abeja europea / abeja de la miel": {
    ...
    "Abeja euglosina negra con bandas naranjas": {
...
function openSpeciesModal(specie) {
    ...
    for (const key in speciesExtraInfo) {
        if (
            name.toLowerCase().includes(key.toLowerCase()) ||
            key.toLowerCase().includes(name.toLowerCase())
        ) {
            extraInfo = speciesExtraInfo[key];
            break;
        }
    }
